        ...
        <div class="service">
            <div class="container">
                    ...
                    <div class="section-header text-center">
                    	...
                    	<p>New Society Member Registration  Pending Request</p>
                    </div>
                    <div>
                    	<%List<Member>member_list=AdminDAO.getMemberPendingList();
                    		int count=0;
                    	%>
                        		...
                        		<tr>
                            		...
                            		<td class="align-middle">
                            			<form action="AdminController" method="post"> 
                            				...
                            				<button class="btn btn-sm btn-success" name="action" value="member_approved"><i class="fas fa-user-check"></i></button>
	        							</form>
                            		</td>
                        		</tr>
                        	<%} %>
