    ...
    <body>
        ...
        <div class="service">
            <div class="container">
                    ...
                    <div>
                    	<%List<NoticeBoard>notice_list=AdminDAO.noticeList(); int count=0;%>
                    	 ...
                    	 <table class="table table-light table-borderless table-hover  mb-0">
                    		...
                    		<%for(NoticeBoard n:notice_list){ count++ ;%>
                        		<tr>
                        	
                            		<td class="align-middle"><%=count %></td>
                            		<td class="align-middle"><%=n.getDate_time() %></td>
                            		<td class="align-middle"><%=n.getSubject()%></td>
                            		<td class="align-middle">
                            			<form action="AdminController" method="post"> 
	        								<input type="hidden" name="email" value="<%=n.getNid()%>">
                            				<button class="btn btn-sm btn-success" name="action" value="member_approved"><i class="fas fa-edit"></i></button>
	        							</form>
                            		</td>
                            		<td class="align-middle">
                            			<form action="AdminController" method="post"> 
	        								<input type="hidden" name="email" value="<%=n.getNid()%>">
                            				<button class="btn danger" name="action" value="member_approved"><i class="fa fa-trash"></i></button>
	        							</form>
                            		</td>
