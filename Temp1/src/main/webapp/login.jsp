            ...
            <div class="container">
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="ml-auto">
                            <a class="btn btn-custom" href="member_registration.jsp">Register</a>
                        </div>
                    </div>
                </nav>
            </div>
                    ...
                    <div class="col-md-7">
                        <div class="contact-form ">
                            ...
                            <form action="MemeberController" method="post">
                                ...
                                <div class="control-group">
                                    <input type="password" class="form-control" id="password" placeholder="Your passowrd" name="password" required="required" data-validation-required-message="Please enter your email" />
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div>
                                    <button class="btn btn-custom" type="submit"  name="action" value="login">Login</button>
                                    <a href="member_forgot_password.jsp" style="padding-left: 25px"> Forgot Password</a>
                                    <a href="member_registration.jsp" style="padding-left: 35px">New Member Registration</a>
                                </div>
