        ...
        <div class="contact">
            <div class="container">
                <div class="section-header text-center">
                  <p>Helping Contact Numbers</p>
                 <h2></h2>
                 
                   <div>
                    	<%List<Member> member_list=AdminDAO.getAllMemberdetails(); int count=0;%>
                    	 ...
                    	 <table class="table table-light table-borderless table-hover  mb-0">
                    		...
                    		<%for(Member m1:member_list){ count++ ;%>
                        		<tr>
                        	
                            		<td class="align-middle"><%=count %></td>
                            		<td class="align-middle"><%=m1.getProf()%></td>
                            		<td class="align-middle"><%=m1.getName()%></td>
                            		<td class="align-middle"><%=m1.getContact()%></td>
