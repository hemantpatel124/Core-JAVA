    ...
    <body>
	   ...
	   <!-- Contact Start -->
                ...
                <div class="row">
                        ...
                        <div class="contact-form">
                            ...
                            <form action="ComplainController" method="post">
                                ...
                                <div class="control-group">
                                    <textarea class="form-control" id="message"  name="complain" placeholder="Description" required="required" data-validation-required-message="Please enter your message"></textarea>
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div>
                                	<input type="hidden" name="mid" value="<%=m.getM_id()%>">
                                    <button class="btn btn-custom" type="submit"  name="action" value="new_complain" >Complain</button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <!-- Contact End -->
         ...
         <!-- Your Complain List Start -->
        <div class="service">
            <div class="container">
            	<%List<Complain>pc_list=ComplainDAO.getComplainByMid(m.getM_id()); int count=0;%>
                 <%boolean flag=pc_list.isEmpty(); %>
                   <%if(flag==false){ %>
                    <div class="section-header text-center">
                    	<h1 >Your Complain</h1>
                    	<p></p>
                    ...
                    <div>
                    	 <table class="table table-light table-borderless table-hover  mb-0">
                    		...
                    		<%for(Complain c:pc_list){ count++ ;%>
                        		<tr>
                        	
                            		<td class="align-middle"><%=count %></td>
                            		<td class="align-middle"><%=c.getDoc() %></td>
                            		<td class="align-middle"><%=c.getSubject()%></td>
                            		<td class="align-middle"><%=c.getComplain()%></td>
                            		<td class="align-middle"><%=c.getStatus()%></td>
