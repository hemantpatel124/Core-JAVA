                            ...
                            <form action="BillingController" method="post">
                      			<div>
                      				<table class="table table-light table-borderless table-hover  mb-0">
                    					...
                    					<tr>	<th class="align-middle">Property Tax</th> <td><input name="ptax" type="text"></td></tr>
                            			<tr>	<th class="align-middle">Water Charge</th> <td><input name="wchg" type="text"></td></tr>
                            			<tr>	<th class="align-middle">Drainage Charge</th> <td><input nmae="dchg" type="text"></td></tr>
                            			<tr>	<th class="align-middle">Street Light Charge</th> <td><input name="slchg" type="text"></td></tr>
                            			<tr>	<th class="align-middle">Fire Charge</th> <td><input name="fchg" type="text"></td></tr>
                            			<tr>	<th class="align-middle">Other Charge</th	> <td><input name="ochg" type="text"></td></tr>
                            			<tr>	<th class="align-middle">Total Amount</th> <td><input name="total_amount"></td></tr>
                                ...
                                <div>
                                    <button class="btn btn-custom" type="submit"  name="action" value="bill_generat" >Generate Bill</button>
                                </div>
                            </form>
                        </div>
                    </div>
