                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="member_pending_req.jsp" class="nav-item nav-link">Pending Request</a>
                            <a href="member_pending_req.jsp" class="nav-item nav-link">Member Details</a>
                ...
                <div class="row">
                        ...
                        <div class="contact-form">
                            ...
                            <form action="AdminController" method="post">
                                ...
                                <div>
                                    <button class="btn btn-custom" type="submit"  name="action" value="notice_generate" >Notice Generate</button>
                                </div>
                            </form>
                        </div>
                    </div>
