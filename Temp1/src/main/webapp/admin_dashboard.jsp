...
<html lang="en">
    ...
    <body>
        ...
        <!-- Page Header End -->
		<!-- Dashboard count number display  start-->	
		<%
			List<Member> apmem_list=AdminDAO.getAllMemberdetails();
			List<Member> pmem_list=AdminDAO.getMemberPendingList();
			List<NoticeBoard> notice_list=MemberDAO.noticeBoard();	
			List<Complain> pc_list=ComplainDAO.getPendingComplain();
		%>
		<!-- Dashboard count number display  end -->   
        <!-- Team Start -->
        <div class="team">
            <div class="container">
                ...
                <div class="row">
                	...
                	<div class="col-lg-3 col-md-6">
                        <div class="team-item" >
                            <div class="team-text" style="background-color: #FCB2AB">
                                <h2>50</h2>
                                <p>Toatl Home</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item">
                            <div class="team-text">
                                <h2><%=pmem_list.size() %></h2>
                                <p>Registration Pending Request</p>
                                <div class="team-social">
                                </div>
                            </div>
                        </div>
