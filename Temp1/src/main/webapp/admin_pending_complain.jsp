    ...
    <body>
        ...
        <div class="service">
            <div class="container">
                    ...
                    <div>
                    	<%List<Complain>pc_list=ComplainDAO.getPendingComplain(); int count=0;%>
                        		...
                        		<tr>
                            		...
                            		<td class="align-middle">
                            			...
                            			<form action="ComplainController" method="post"> 
	        								...
	        								<a href="admin_replay_complain.jsp?cid=<%=c.getCid()%>" >Replay</a>
                            				<!-- <button class="btn btn-sm btn-success" name="action" value="replay_complain"><i class="fas fa-reply"></i></button>  -->
	        							</form>
                            		</td>
