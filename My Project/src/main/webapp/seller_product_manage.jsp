    ...
    <div class="container-fluid">
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
            	<% List<Product> product_list=ProductDAO.getProductBySid(u.getId()); %>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                            	<form action="ProductController" method="post"> 
                            		...
                            		<button class="btn btn-sm btn-primary" name="action" value="product_edit"><i class="fas fa-edit"></i></button>
	        					</form>
                            </td>
                            <td class="align-middle">
                            		<a href="product_delete.jsp?pid=<%=p.getPid() %>" >Delete</a>
                            </td>
                        </tr>
                        <%} %>
                          </tbody>
