...
<body>
    ...
    <!-- Contact Start -->
    <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Product Edit</span></h2>
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    ...
                    <form name="sentMessage" action="ProductController" novalidate="novalidate" method="post" enctype="multipart/form-data">
        				
        				
        				<input type="hidden" class="form-control" id="name" name="sid" value="<%=s.getId()%>">
        				<input type="hidden" class="form-control" id="name" name="pid" value="<%=p.getPid()%>">
        				
        				
						
                        <div class="control-group">
                        
                            <img class="img-fluid w-25"src="image/<%=p.getImage() %>"  alt="">
                            <input type="file" class="form-control" id="subject" placeholder="Please choose your file" name="image"
                                required="required" />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" value="<%=p.getPname()%>"name="pname"
                                required="required"  />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" value="<%=p.getPrice() %>"name="pprice"
                                required="required"  />
                            <p class="help-block text-danger"></p>
                        </div>
                        
                        <div class="control-group">
                            <input type="text" class="form-control" id="subject" value="<%=p.getPcategory() %>" name="pcategory"
                                required="required"  />
                            <p class="help-block text-danger"></p>
                        </div>
                        <div>
                            <button class="btn btn-primary py-2 px-4" type="submit" id="sendMessageButton" name="action" value="update_product">Update Product
                                </button>
                        </div>
                    </form>
                </div>
