...
<body>
	...
	<div class="container-fluid pt-5 pb-3">
        <div class="row px-xl-5">
        	...
        	<%List<Product> product_list=ProductDAO.getAllProduct();%>
                ...
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href="CartController?action=addtocart&pid=<%=p.getPid()%>&cusid=<%=c.getId()%>"><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href="WishlistController?action=addtowishlist&pid=<%=p.getPid()%>&cusid=<%=c.getId()%>"><i class="far fa-heart"></i></a>
                        </div>
                    </div>
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href=""><%=p.getPname() %></a>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>Rs. <%=p.getPrice() %></h5><h6 class="text-muted ml-2"><del></del></h6>
                        </div>
                    </div>
                </div>
            </div>
