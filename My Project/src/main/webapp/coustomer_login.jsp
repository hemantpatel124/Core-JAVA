...
<body>
    ...
    <!-- Contact Start -->
    <div class="container-fluid">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Coustomer Login</span></h2>
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    ...
                    <form name="sentMessage" action="CoustomerController" novalidate="novalidate" method="post">
						...
						<%String msg2=(String)request.getAttribute("cngps"); %>
						<%if(msg2!=null){ %>
						<h3><%out.print(msg2); %></h3>
						<% }%>
                        ...
                        <div>
                            <button class="btn btn-primary py-2 px-4" type="submit" id="sendMessageButton" name="action" value="login">Login
                             ...
                             <a href="coustomer_forgate_password.jsp" class="nav-item nav-link">Forgate Password</a>
                    </form>
                </div>
            </div>
