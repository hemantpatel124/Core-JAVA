   ...
   <!-- Navbar Start -->
    ...
    <div class="jumbotron jumbotron-fluid page-header position-relative overlay-bottom" style="margin-bottom: 90px;">
        <div class="container text-center py-5">
            <h1 class="text-white display-1">Faculty  Details</h1>
    ...
    <div class="container-fluid bg-image" style="margin: 90px 0;">
        <div class="container">
            <div class="row">
         		<%List <Faculty> s_list=FacultyDAO.getFaculty(s.getDcode()); int count=1; %>
				...
				<table class="table">
					...
					<%for(Faculty f:s_list){%>
					  <tbody>
					    <tr>
					      <th><%=count++ %></th>
					      <td><%=f.getFname() %></td>
					      <td>
					      		<%List<Subject> sub_list=FacultyDAO.getSubjectByFacultyid(f.getFid());%>
					      		<%for (Subject s1:sub_list){ %>
					      			<%=s1.getSubname()%>,
					      		<%} %>
					      </td>
